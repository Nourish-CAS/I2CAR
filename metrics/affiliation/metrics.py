...
def produce_all_results():
    ...
    contained in the `dataset` repository
    :return: a dictionary indexed by dataset names, each containing a dictionary
    ...
    """
    datasets, Tranges = read_all_as_events() # read all the events in folder `dataset`
    results = dict()
